...
class MainComposeActivity : ComponentActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContent {
            ...
            // To perform work over the life of a composable and have the ability to call suspend functions, use the LaunchedEffect composable
           /* LaunchedEffect(Unit) {
                catlist = showCatPics()
            }
    ...
    private fun showCatPics1():List<Picture> {
        val retrofitBuilder = Retrofit.Builder()
            .baseUrl(PictureService.ROOT_URL)
            .addConverterFactory(GsonConverterFactory.create())
            .build()
        ...
        val catlist: Call<List<Picture>> = retrofitobj.getPicturesList()
        System.out.println("size of the cat list in showcatpics()" + catlist.size)
        return catlist
